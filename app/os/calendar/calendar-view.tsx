...
import { calEventMeta, type CalEvent, type CalEventType } from "@/lib/fixtures/calendar";
import { useCalendarEvents, eventsOn, upcomingEvents } from "@/lib/client/calendar-context";
...
export default function CalendarView() {
  ...
  const upcoming = upcomingEvents(events, todayIso, 8);
