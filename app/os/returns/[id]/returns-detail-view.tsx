                ...
                {chat.messages.map(m =>
                  m.role === "user" ? (
                    ...
                    <div key={m.id}>
                      ...
                      <PetalAnswerView answer={m.answer} thinking={m.thinking} liveSteps={m.liveSteps} compact stream={m.id === [...chat.messages].reverse().find(x => x.role === "petal")?.id} onSuggest={q => sendChat(q)} />
                    </div>
                  ),
                )}
