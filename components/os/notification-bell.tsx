      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-0 top-[calc(100%+6px)] z-40 w-[330px] overflow-hidden rounded-xl border border-[var(--os-border)] bg-[var(--os-surface)] shadow-[0_12px_40px_-8px_rgba(17,17,26,0.28)]"
          >
