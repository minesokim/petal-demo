      ...
      {TRUST_TIER_ORDER.map(t => {
        ...
        return (
          <button
            ...
            className={cn(
              "inline-flex items-center gap-1.5 rounded-[6px] px-2 py-1 text-[11.5px] font-medium transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--os-accent)]",
