...
import { Button, Row, Screen, Stack } from "../primitives";
import { useIntakeStore } from "@/lib/portal/intake-store";

/**
 * Tutorial overlay — 1:1 port of design-references/client-portal/
 * components/tutorial.jsx. Three sequential cards (the modal
 * overlays a blurred intake mock behind it) showing how taps work,
 * how Ask Antonio works, and a summary cheatsheet.
 */

function TutorialDemoCards({ t }: { t: PortalTheme }) {
...
function TutorialAntonioDemo({ t }: { t: PortalTheme }) {
  ...
  return (
    <div style={{ marginTop: 14 }}>
      <div
        ...
        <span style={{ flex: 1, fontSize: 13, color: t.inkSoft }}>
      ...
      <div
        ...
        <div
          ...
          &ldquo;No worries! Just type your question and I&apos;ll get back to
          you personally. Nothing is a dumb question.&rdquo;
        </div>
      </div>
...
function TutorialCard({
  ...
  if (step === 1) {
    ...
    sub =
      "If you're stuck on any question, tap below to message Antonio.";
    body = <TutorialAntonioDemo t={t} />;
  } else {
    headline = "You're ready.";
    sub =
      "Answer what you can, skip what you can't, message me for anything.";
    const lines = [
        ...
        {lines.map((line, i) => (
          <div
            ...
            style={{
              ...
              padding: "8px 0",
              borderBottom:
                i < lines.length - 1 ? `1px solid ${t.borderSoft}` : "none"
            }}>
            <span
              style={{
                fontFamily: t.mono,
  ...
  return (
    <div
      style={{
        ...
        animation: "portal-tut-fade 0.28s ease-out"
      }}>
      <Stack gap={14}>
        {badge}
        <Stack gap={6}>
...
export function ScreenTutorial({ t }: { t: PortalTheme }) {
  ...
  return (
    <Screen t={t}>
      <div style={{ position: "relative", width: "100%", height: "100%" }}>
        {/* Blurred base — mimics a sample intake screen behind the modal */}
        <div
          style={{
            position: "absolute",
            inset: 0,
          ...
          <div style={{ padding: "32px 24px", background: t.bg, height: "100%" }}>
            <div
              style={{
                fontFamily: t.mono,
                fontSize: 10,
        ...
        <div
          ...
          <TutorialCard
            ...
            step={step}
            total={3}
            onNext={() => (step < 3 ? setStep(step + 1) : done())}
            onSkip={done}
          />
        </div>
      </div>
