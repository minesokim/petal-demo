...
export type ReturnStage = 'not_started' | 'intake_sent' | 'docs_collecting' | 'docs_complete' | 'in_prep' | 'in_review' | 'ready_to_sign' | 'filed'
...
export const clients: Client[] = [
  { id: 'c1', fullName: 'Marcus Chen', email: 'marcus.chen@gmail.com', phone: '(951) 555-0142', filingStatus: 'mfj', returnStage: 'in_prep', serviceTier: 'Premium', feeAmount: 500, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-27T14:30:00', lastPortalLogin: '2026-03-27T09:15:00', documentsSubmitted: 8, documentsRequired: 10, notes: 'Restaurant owner. Needs Schedule C + SE tax. Has 3 locations.', type: 'business', businessName: 'Golden Dragon LLC', avatar: '/images/avatars/01.png' },
  { id: 'c2', fullName: 'Priya Sharma', email: 'priya.sharma@outlook.com', phone: '(951) 555-0198', filingStatus: 'single', returnStage: 'docs_collecting', serviceTier: 'Standard', feeAmount: 350, depositPaid: true, urgency: 'high', lastActivity: '2026-03-25T11:00:00', lastPortalLogin: '2026-03-22T16:30:00', documentsSubmitted: 3, documentsRequired: 7, notes: 'TikTok creator. Multiple 1099-NECs. First year filing with us.', type: 'individual', avatar: '/images/avatars/02.png' },
  { id: 'c3', fullName: 'James & Sofia Rodriguez', email: 'jrodriguez@yahoo.com', phone: '(909) 555-0176', filingStatus: 'mfj', returnStage: 'ready_to_sign', serviceTier: 'Premium', feeAmount: 500, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-28T08:00:00', lastPortalLogin: '2026-03-28T07:45:00', documentsSubmitted: 12, documentsRequired: 12, notes: 'Rental property income. 2 dependents. Been with us 3 years.', type: 'individual', avatar: '/images/avatars/03.png' },
  { id: 'c4', fullName: 'DeShawn Williams', email: 'deshawn.w@gmail.com', phone: '(951) 555-0134', filingStatus: 'hoh', returnStage: 'docs_collecting', serviceTier: 'Basic', feeAmount: 150, depositPaid: false, urgency: 'urgent', lastActivity: '2026-03-18T09:30:00', lastPortalLogin: null, documentsSubmitted: 1, documentsRequired: 6, notes: 'New client. Head of household with 2 kids. Needs to upload W-2 still.', type: 'individual', avatar: '/images/avatars/04.png' },
  ...
  { id: 'c6', fullName: 'Roberto Fuentes', email: 'roberto@fuentestrucking.com', phone: '(909) 555-0188', filingStatus: 'mfj', returnStage: 'in_review', serviceTier: 'Premium', feeAmount: 500, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-27T16:00:00', lastPortalLogin: '2026-03-26T11:20:00', documentsSubmitted: 15, documentsRequired: 15, notes: 'Trucking company. 1120S + personal. Complex depreciation schedules.', type: 'business', businessName: 'Fuentes Transport Inc', avatar: '/images/avatars/06.png' },
  { id: 'c7', fullName: 'Ashley Kim', email: 'ashley.kim@icloud.com', phone: '(714) 555-0167', filingStatus: 'single', returnStage: 'intake_sent', serviceTier: 'Standard', feeAmount: 350, depositPaid: false, urgency: 'normal', lastActivity: '2026-03-26T14:00:00', lastPortalLogin: null, documentsSubmitted: 0, documentsRequired: 8, notes: 'OnlyFans creator. Referred by Priya. Needs help with estimated payments.', type: 'individual', avatar: '/images/avatars/07.png' },
  { id: 'c8', fullName: 'Thomas & Marie DuBois', email: 'tdubois@gmail.com', phone: '(951) 555-0145', filingStatus: 'mfj', returnStage: 'in_prep', serviceTier: 'Premium', feeAmount: 500, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-27T11:30:00', lastPortalLogin: '2026-03-25T08:00:00', documentsSubmitted: 11, documentsRequired: 14, notes: 'Both W-2 + rental property. Crypto trades this year.', type: 'individual', avatar: '/images/avatars/08.png' },
  { id: 'c9', fullName: 'Miguel Sandoval', email: 'miguel@sandovalplumbing.com', phone: '(909) 555-0199', filingStatus: 'mfj', returnStage: 'docs_complete', serviceTier: 'Premium', feeAmount: 500, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-26T09:00:00', lastPortalLogin: '2026-03-26T08:45:00', documentsSubmitted: 9, documentsRequired: 9, notes: 'Plumbing business. Schedule C. Wants to incorporate this year.', type: 'business', businessName: 'Sandoval Plumbing', avatar: '/images/avatars/09.png' },
  ...
  { id: 'c11', fullName: 'David Park', email: 'dpark@parkdental.com', phone: '(714) 555-0123', filingStatus: 'mfj', returnStage: 'in_prep', serviceTier: 'Premium', feeAmount: 500, depositPaid: true, urgency: 'high', lastActivity: '2026-03-28T07:00:00', lastPortalLogin: '2026-03-27T20:00:00', documentsSubmitted: 18, documentsRequired: 20, notes: 'Dental practice S-Corp. Multiple employees. Payroll complexity.', type: 'business', businessName: 'Park Family Dental', avatar: '/images/avatars/11.png' },
  { id: 'c12', fullName: 'Jasmine Torres', email: 'jas.torres@gmail.com', phone: '(951) 555-0156', filingStatus: 'hoh', returnStage: 'docs_collecting', serviceTier: 'Standard', feeAmount: 350, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-24T13:00:00', lastPortalLogin: '2026-03-24T13:00:00', documentsSubmitted: 4, documentsRequired: 8, notes: 'Freelance graphic designer. 1 dependent. Multiple 1099s.', type: 'individual', avatar: '/images/avatars/12.png' },
  { id: 'c13', fullName: 'Vladimir Petrov', email: 'vlad@petrovimports.com', phone: '(909) 555-0134', filingStatus: 'mfj', returnStage: 'not_started', serviceTier: 'Premium', feeAmount: 500, depositPaid: false, urgency: 'high', lastActivity: '2026-03-20T10:00:00', lastPortalLogin: null, documentsSubmitted: 0, documentsRequired: 16, notes: 'Import/export business. Needs extension likely. Complex international.', type: 'business', businessName: 'Petrov Imports LLC', avatar: '/images/avatars/01.png' },
  { id: 'c14', fullName: 'Aisha Johnson', email: 'aisha.j@outlook.com', phone: '(626) 555-0189', filingStatus: 'single', returnStage: 'ready_to_sign', serviceTier: 'Standard', feeAmount: 350, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-28T09:00:00', lastPortalLogin: '2026-03-28T08:30:00', documentsSubmitted: 6, documentsRequired: 6, notes: 'Nurse. W-2 + side hustle selling scrubs online.', type: 'individual', avatar: '/images/avatars/02.png' },
  { id: 'c15', fullName: 'Carlos & Elena Mendez', email: 'cmendez@mendezauto.com', phone: '(951) 555-0177', filingStatus: 'mfj', returnStage: 'in_prep', serviceTier: 'Premium', feeAmount: 500, depositPaid: true, urgency: 'normal', lastActivity: '2026-03-27T15:00:00', lastPortalLogin: '2026-03-26T19:00:00', documentsSubmitted: 13, documentsRequired: 14, notes: 'Auto repair shop. 1065 partnership. 4 dependents.', type: 'business', businessName: 'Mendez Auto Repair', avatar: '/images/avatars/03.png' },
  ...
  { id: 'c17', fullName: 'Tyrone Mitchell', email: 'tyrone.m@gmail.com', phone: '(909) 555-0167', filingStatus: 'single', returnStage: 'docs_collecting', serviceTier: 'Basic', feeAmount: 150, depositPaid: true, urgency: 'urgent', lastActivity: '2026-03-19T08:00:00', lastPortalLogin: '2026-03-19T08:00:00', documentsSubmitted: 2, documentsRequired: 5, notes: 'Uber/Lyft driver. Needs help tracking mileage. Last year extended.', type: 'individual', avatar: '/images/avatars/05.png' },
...
export const pipelineCounts = {
  not_started: clients.filter(c => c.returnStage === 'not_started').length,
  intake_sent: clients.filter(c => c.returnStage === 'intake_sent').length,
  docs_collecting: clients.filter(c => c.returnStage === 'docs_collecting').length,
  docs_complete: clients.filter(c => c.returnStage === 'docs_complete').length,
  in_prep: clients.filter(c => c.returnStage === 'in_prep').length,
  in_review: clients.filter(c => c.returnStage === 'in_review').length,
  ready_to_sign: clients.filter(c => c.returnStage === 'ready_to_sign').length,
...
export const stageLabels: Record<ReturnStage, string> = {
  ...
  docs_collecting: 'Collecting Docs',
...
export const stageColors: Record<ReturnStage, string> = {
  not_started: 'bg-gray-100 text-text-secondary',
  intake_sent: 'bg-blue-light text-blue',
  docs_collecting: 'bg-amber-light text-amber',
  docs_complete: 'bg-accent-light text-accent',
  in_prep: 'bg-blue-light text-blue',
  in_review: 'bg-warm-light text-warm',
  ready_to_sign: 'bg-accent-light text-accent',
