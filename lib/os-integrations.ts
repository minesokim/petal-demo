...
export const integrations: Integration[] = [
  ...
  { id: "xero", name: "Xero", category: "Accounting", desc: "Two-way sync of ledgers and contacts.", status: "available", gradient: "from-sky-500 to-blue-600", glyph: Exchange01Icon },
  ...
  // Tax & e-file
  { id: "olt", name: "OLT Pro", category: "Tax & e-file", desc: "Transmits approved returns; acknowledgments sync back.", status: "connected", gradient: "from-slate-600 to-slate-800", glyph: InvoiceIcon, account: "EFIN ••2231", lastSync: "Live" },
  { id: "irs", name: "IRS e-Services", category: "Tax & e-file", desc: "Pull transcripts and CAF authorizations.", status: "connected", gradient: "from-blue-600 to-indigo-700", glyph: SecurityCheckIcon, account: "Transcripts + CAF · 8821 on file for 9 clients", lastSync: "Today 6:05 AM" },
  ...
  { id: "gcal", name: "Google Calendar", category: "Email & calendar", desc: "Read events so pre-call briefs arrive before each call.", status: "connected", gradient: "from-blue-500 to-indigo-600", glyph: Calendar03Icon, account: "antonio@vazant.tax", lastSync: "Live" },
  ...
  // Client data sources
  { id: "square", name: "Square", category: "Client data sources", desc: "Card payments and POS exports for Schedule C.", status: "connected", gradient: "from-slate-700 to-slate-900", glyph: InvoiceIcon, account: "Vazant EA", lastSync: "Today" },
