...
export const OBBBA_FEDERAL_CHUNKS: ObbbaAuthorityChunk[] = [
  // ── SALT cap (OBBBA §70120, amending IRC §164(b)(6)+(7)) ──
  {
    ...
    verified: true,
    text:
      "OBBBA replaced the flat $10,000 state-and-local-tax (SALT) deduction cap with an 'applicable limitation amount': $40,000 for tax years beginning in 2025, $40,400 for 2026, then 101% of the prior year's amount for 2027-2029 (married filing separately gets half). The cap phases DOWN for high earners: it is reduced by 30% of the excess of modified adjusted gross income over a threshold amount ($500,000 for 2025; $505,000 for 2026; 101% of the prior year thereafter), but the reduction can never push the cap below $10,000. For tax years beginning after calendar year 2029 the applicable limitation amount reverts to $10,000 ($5,000 MFS). MAGI here is AGI increased by amounts excluded under §911/§931/§933.",
  ...
  // ── Senior additional deduction (OBBBA §70103, new IRC §151(d)(5)(C)) ──
  {
    ...
    verified: true,
    text:
      "OBBBA added a temporary additional deduction of $6,000 for each qualified individual — the taxpayer (and, on a joint return, the spouse) who has attained age 65 before the close of the taxable year. Phase-out: the $6,000 is reduced (but not below zero) by 6% of the excess of modified adjusted gross income over $75,000 ($150,000 on a joint return). A valid SSN is required and married taxpayers must file jointly. Allowed only for tax years beginning before January 1, 2029 (i.e., 2025 through 2028).",
