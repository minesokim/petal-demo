...
export const MEASURED_BASELINE: MeasuredRun[] = [
  ...
  { set: "generated", description: "honest all-10-areas verified benchmark (50 cases). 12/50 raw baseline → 15/50 after DISTILLING 12 empty-area sections (FTC/GILTI/estate/accounting) the figure-gated way — proving the lever is DISTILLED operative rules (answerable), not raw full-text (retrievable only). Each ~12 distilled sections ≈ +6 pts; keep distilling the thin areas to climb. retrieve-then-extract = the automation (moat-touching, pending go).", model: "gpt-5.5 (codex)", config: "--set generated", total: 50, pass: 15, errorRatePct: 70.0, date: "2026-06-27" },
