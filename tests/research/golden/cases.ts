...
export const GOLDEN_CASES: GoldenCase[] = [
  ...
  // ───────────────────────── Case law (foundational federal doctrines; web-verified corpus) ─────────────
  {
    id: "case-economic-substance-gregory",
    question: "Can the IRS disregard a transaction that technically satisfies the words of a tax statute but has no business purpose other than avoiding tax?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Gregory",
    notes: "Business-purpose / substance-over-form doctrine. Gregory v. Helvering, 293 U.S. 465 (1935); later partially codified at §7701(o).",
  },
  {
    id: "case-gross-income-glenshaw",
    question: "Are punitive damages a taxpayer recovers in litigation included in gross income?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Glenshaw",
    notes: "Yes — gross income reaches all 'accessions to wealth, clearly realized, over which the taxpayer has complete dominion.' Commissioner v. Glenshaw Glass, 348 U.S. 426 (1955).",
  },
  {
    id: "case-ordinary-necessary-welch",
    question: "When deciding if a business expense is deductible as 'ordinary and necessary,' what does the word 'necessary' require?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Welch",
    notes: "'Necessary' means appropriate and helpful to the business (a low threshold); the harder requirement is 'ordinary.' Welch v. Helvering, 290 U.S. 111 (1933).",
  },
  {
    id: "case-cohan-estimate",
    question: "My client clearly incurred deductible business expenses but kept no receipts. Can any deduction be allowed, or is it disallowed entirely?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Cohan",
    notes: "The Cohan rule: the court may estimate a reasonable amount rather than disallow entirely. Cohan v. Commissioner, 39 F.2d 540 (2d Cir. 1930). (Not for §274(d) strict-substantiation items.)",
  },
  {
    id: "case-crane-nonrecourse-basis",
    question: "Does a taxpayer's basis in real property include a nonrecourse mortgage that the taxpayer did not personally assume?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Crane",
    notes: "Yes — basis is full FMV including the nonrecourse debt, and the amount realized on sale includes the outstanding principal. Crane v. Commissioner, 331 U.S. 1 (1947).",
  },
  {
    id: "case-indopco-capitalization",
    question: "Are the professional fees a corporation pays in a friendly acquisition currently deductible, or must they be capitalized?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "INDOPCO",
    notes: "Capitalized — an expenditure producing benefits beyond the tax year must be capitalized even if it creates no separate asset. INDOPCO v. Commissioner, 503 U.S. 79 (1992).",
  },

  // ── Case law batch 2 (assignment of income, claim of right, gifts, illegal income) ──
  {
    id: "case-lucas-v-earl",
    question: "Can someone shift the income tax on their own salary or wages to their spouse by an anticipatory contract?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Lucas v. Earl",
    notes: "Lucas v. Earl, 281 U.S. 111 (1930).",
  },
  {
    id: "case-helvering-v-horst",
    question: "A bondholder gives away the interest coupons but keeps the bonds. Who is taxed on the interest income?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Horst",
    notes: "Helvering v. Horst, 311 U.S. 112 (1940).",
  },
  {
    id: "case-old-colony-trust-co-v-commissioner",
    question: "If an employer pays an employee's personal income taxes as part of compensation, is that additional taxable income to the employee?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Old Colony",
    notes: "Old Colony Trust Co. v. Commissioner, 279 U.S. 716 (1929).",
  },
  {
    id: "case-james-v-united-states",
    question: "Is money obtained illegally, such as embezzled funds, taxable as gross income?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "James v. United",
    notes: "James v. United States, 366 U.S. 213 (1961).",
  },
  {
    id: "case-commissioner-of-internal-revenue-v-duberstein",
    question: "What is the legal standard for deciding whether a transfer qualifies as a tax-free gift?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "Duberstein",
    notes: "Commissioner of Internal Revenue v. Duberstein, 363 U.S. 278 (1960).",
  },
  {
    id: "case-north-american-oil-consolidated-v-burnet",
    question: "If a taxpayer receives money under a claim of right without restriction on its use, when is it taxed, even if a later obligation to repay might arise?",
    taxYear: 2025,
    jurisdiction: "federal",
    expectedBucket: "answer",
    mustCiteAuthorityLike: "North American Oil",
    notes: "North American Oil Consolidated v. Burnet, 286 U.S. 417 (1932).",
  },];
